...
public class IoK8sKubernetesPkgApiV1ExecAction {
  @SerializedName("command")
  private List<String> command = null;

  public IoK8sKubernetesPkgApiV1ExecAction command(List<String> command) {
    this.command = command;
    return this;
  }

  public IoK8sKubernetesPkgApiV1ExecAction addCommandItem(String commandItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IoK8sKubernetesPkgApiV1ExecAction ioK8sKubernetesPkgApiV1ExecAction = (IoK8sKubernetesPkgApiV1ExecAction) o;
    return Objects.equals(this.command, ioK8sKubernetesPkgApiV1ExecAction.command);
  }
  ...
  public String toString() {
    ...
    sb.append("class IoK8sKubernetesPkgApiV1ExecAction {\n");
