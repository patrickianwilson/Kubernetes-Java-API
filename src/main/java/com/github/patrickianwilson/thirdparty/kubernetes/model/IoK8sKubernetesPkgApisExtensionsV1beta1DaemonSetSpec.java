...
import com.github.patrickianwilson.thirdparty.kubernetes.model.IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetUpdateStrategy;
...
public class IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec {
  ...
  private IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetUpdateStrategy updateStrategy = null;

  public IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec minReadySeconds(Integer minReadySeconds) {
  ...
  **/
  ...
  public IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec revisionHistoryLimit(Integer revisionHistoryLimit) {
  ...
  **/
  ...
  public IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec selector(IoK8sApimachineryPkgApisMetaV1LabelSelector selector) {
  ...
  **/
  ...
  public IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec template(IoK8sKubernetesPkgApiV1PodTemplateSpec template) {
  ...
  **/
  ...
  public IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec templateGeneration(Long templateGeneration) {
  ...
  **/
  ...
  public IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec updateStrategy(IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetUpdateStrategy updateStrategy) {
  ...
  **/
  ...
  public IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetUpdateStrategy getUpdateStrategy() {
    return updateStrategy;
  }

  public void setUpdateStrategy(IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetUpdateStrategy updateStrategy) {
    this.updateStrategy = updateStrategy;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec ioK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec = (IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec) o;
    return Objects.equals(this.minReadySeconds, ioK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec.minReadySeconds) &&
        Objects.equals(this.revisionHistoryLimit, ioK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec.revisionHistoryLimit) &&
        Objects.equals(this.selector, ioK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec.selector) &&
        Objects.equals(this.template, ioK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec.template) &&
        Objects.equals(this.templateGeneration, ioK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec.templateGeneration) &&
        Objects.equals(this.updateStrategy, ioK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec.updateStrategy);
  }
