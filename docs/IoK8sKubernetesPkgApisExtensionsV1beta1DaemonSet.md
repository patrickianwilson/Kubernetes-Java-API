...
**spec** | [**IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec**](IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetSpec.md) | The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status |  [optional]
**status** | [**IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus**](IoK8sKubernetesPkgApisExtensionsV1beta1DaemonSetStatus.md) | The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status |  [optional]
